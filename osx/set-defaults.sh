...
# Setting up better defaults in OSX
# Thanks, Zach Holman (https://github.com/holman/dotfiles/blob/master/osx/set-defaults.sh)
# and Mathias Bynens (https://github.com/mathiasbynens/dotfiles/blob/master/.osx)
...
# Trackpad: two-finger click -> right-click
